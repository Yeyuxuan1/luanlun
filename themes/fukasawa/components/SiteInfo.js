...
function SiteInfo ({ title }) {
  ...
  return (
        ...
        >
            ...
            <br />
            <span className='text-xs font-serif'> Powered by <a href='https://inky-pullover-cfb.notion.site/c60d46307c6e49f3af820f0a76769113' className='underline text-gray-500 dark:text-gray-300'>数字花园 {BLOG.VERSION}</a></span><br /></span>
            <h1>{title}</h1>
        </footer>
  )
}
